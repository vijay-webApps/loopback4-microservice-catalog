...
import { AwsTranslateProvider, JsdomService } from "./services";
...
export class LanguageTranslateServiceComponent implements Component {
  ...
  constructor(
    ...
    if (serviceName === ServiceNames.AWS) {
      ...
      this.application.bind(LanguageTranslateBindings.languageTranslateProvider).toProvider(AwsTranslateProvider);
    }
    this.application.bind(LanguageTranslateBindings.jsDomService).toClass(JsdomService);
